    ...
    var generateComponentMJML = function (component) {
        ...
        switch (component.type) {
            ...
            case 'footer':
                ...
                return "\n          <mj-section padding=\"".concat(props.padding || '0px', "\" background-color=\"").concat(props.backgroundColor || 'transparent', "\">\n            <mj-column>\n              ").concat(props.companyName ? "\n                <mj-text \n                  font-size=\"18px\" \n                  font-weight=\"bold\" \n                  color=\"".concat(props.companyNameColor || '#111827', "\"\n                  align=\"").concat(props.contentAlignment || 'center', "\"\n                  padding=\"0 0 15px 0\"\n                >\n                  ").concat(props.companyName, "\n                </mj-text>\n              ") : '', "\n              ").concat(props.address ? "\n                <mj-text \n                  font-size=\"14px\" \n                  color=\"".concat(props.contactTextColor || '#6b7280', "\"\n                  align=\"").concat(props.contentAlignment || 'center', "\"\n                  padding=\"5px 0\"\n                >\n                  ").concat(props.address, "\n                </mj-text>\n              ") : '', "\n              ").concat(props.phone ? "\n                <mj-text \n                  font-size=\"14px\" \n                  color=\"".concat(props.contactTextColor || '#6b7280', "\"\n                  align=\"").concat(props.contentAlignment || 'center', "\"\n                  padding=\"5px 0\"\n                >\n                  ").concat(props.phone, "\n                </mj-text>\n              ") : '', "\n              ").concat(props.email ? "\n                <mj-text \n                  font-size=\"14px\" \n                  color=\"".concat(props.contactTextColor || '#6b7280', "\"\n                  align=\"").concat(props.contentAlignment || 'center', "\"\n                  padding=\"5px 0\"\n                >\n                  ").concat(props.email, "\n                </mj-text>\n              ") : '', "\n              ").concat(props.socialLinks && props.socialLinks.length > 0 ? "\n                <mj-text \n                  font-size=\"14px\" \n                  align=\"".concat(props.contentAlignment || 'center', "\"\n                  padding=\"15px 0\"\n                >\n                  ").concat(props.socialLinks.map(function (link) {
                    return "<a href=\"".concat(link.url, "\" style=\"margin: 0 10px; color: ").concat(props.socialTextColor || '#6b7280', "; text-decoration: none; display: inline-block; vertical-align: middle;\">\n                      <img src=\"").concat(link.imageUrl, "\" alt=\"").concat(link.title, "\" width=\"16\" height=\"16\" style=\"display: inline-block; vertical-align: middle; margin-right: 5px;\">\n                      ").concat(link.title, "\n                    </a>");
                }).join(''), "\n                </mj-text>\n              ") : '', "\n              ").concat(props.unsubscribeText ? "\n                <mj-text \n                  font-size=\"12px\" \n                  color=\"".concat(props.unsubscribeTextColor || '#9ca3af', "\"\n                  align=\"").concat(props.contentAlignment || 'center', "\"\n                  padding=\"15px 0 0 0\"\n                >\n                  <a href=\"").concat(props.unsubscribeUrl || '#', "\" style=\"color: ").concat(props.unsubscribeTextColor || '#9ca3af', "; text-decoration: none;\">").concat(props.unsubscribeText, "</a>\n                </mj-text>\n              ") : '', "\n            </mj-column>\n          </mj-section>\n        ");
            case 'socialMedia':
