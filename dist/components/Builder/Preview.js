...
var Preview = function (_a) {
    var template = _a.template, isPreviewMode = _a.isPreviewMode, onTogglePreview = _a.onTogglePreview;
    var renderPreviewComponent = function (component) {
        switch (component.type) {
            case 'header':
                return ((0, jsx_runtime_1.jsxs)("div", __assign({ className: "w-full text-center", style: {
            ...
            case 'text':
                return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "w-full", style: { padding: component.props.padding || '5px' } }, { children: component.props.textVisible !== false && ((0, jsx_runtime_1.jsx)("div", __assign({ className: "prose max-w-none", style: {
            ...
            case 'image':
                return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "w-full", style: { padding: component.props.padding || '5px' } }, { children: component.props.imageVisible !== false && ((0, jsx_runtime_1.jsx)("div", __assign({ className: "flex", style: {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ className: "fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "bg-white rounded-lg shadow-xl max-w-4xl w-full max-h-[90vh] overflow-hidden" }, { children: [(0, jsx_runtime_1.jsxs)("div", __assign({ className: "flex items-center justify-between p-4 border-b border-gray-200" }, { children: [(0, jsx_runtime_1.jsx)("h2", __assign({ className: "text-lg font-semibold text-gray-900" }, { children: "Email Preview" })), (0, jsx_runtime_1.jsxs)("div", __assign({ className: "flex items-center space-x-3" }, { children: [(0, jsx_runtime_1.jsxs)("span", __assign({ className: "text-sm text-gray-500" }, { children: [template.settings.width, " width"] })), (0, jsx_runtime_1.jsx)("button", __assign({ onClick: onTogglePreview, className: "text-gray-400 hover:text-gray-600 transition-colors" }, { children: (0, jsx_runtime_1.jsx)("svg", __assign({ className: "w-6 h-6", fill: "none", stroke: "currentColor", viewBox: "0 0 24 24" }, { children: (0, jsx_runtime_1.jsx)("path", { strokeLinecap: "round", strokeLinejoin: "round", strokeWidth: 2, d: "M6 18L18 6M6 6l12 12" }) })) }))] }))] })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "overflow-y-auto p-4" }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "mx-auto bg-white shadow-lg", style: {
                        ...
                        } }, { children: template.components.map(function (component, index) { return ((0, jsx_runtime_1.jsx)("div", { children: renderPreviewComponent(component) }, "".concat(component.id, "-").concat(index))); }) })) })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "p-4 border-t border-gray-200 bg-gray-50" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "flex items-center justify-between text-sm text-gray-500" }, { children: [(0, jsx_runtime_1.jsx)("span", { children: "Preview Mode" }), (0, jsx_runtime_1.jsxs)("span", { children: ["Template: ", template.name] })] })) }))] })) })));
};
