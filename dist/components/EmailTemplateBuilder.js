...
var EmailTemplateBuilder = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsx)(react_dnd_1.DndProvider, __assign({ backend: react_dnd_html5_backend_1.HTML5Backend }, { children: (0, jsx_runtime_1.jsx)("div", __assign({ className: "bg-gray-50 ".concat(className), style: style }, { children: (0, jsx_runtime_1.jsx)("main", __assign({ className: "w-full px-2 py-2" }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ className: "grid grid-cols-12 gap-6 h-full" }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ className: "col-span-3" }, { children: (0, jsx_runtime_1.jsx)(ComponentLibrary_1.ComponentLibrary, {}) })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "col-span-6" }, { children: (0, jsx_runtime_1.jsx)(Builder_1.Builder, {}) })), (0, jsx_runtime_1.jsx)("div", __assign({ className: "col-span-3" }, { children: (0, jsx_runtime_1.jsx)(Inspector_1.Inspector, {}) }))] })) })) })) })));
};
